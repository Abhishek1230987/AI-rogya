...
router.post("/transcribe", upload.single("audio"), transcribeUploadHandler);

// @route   POST /api/voice/text-consultation
// @desc    Process text-based consultation (from speech recognition or typed text)
// @access  Private
...
// @desc    Delete a specific consultation by ID
// @access  Private
router.delete("/:id", authenticateToken, deleteConsultation);

// @route   DELETE /api/voice
// @desc    Delete all consultations for current user
// @access  Private
router.delete("/", authenticateToken, clearConsultations);
